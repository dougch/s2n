...
/*
      ...
      */  let result =s2n_cipher_suites_init();
        ...
        let result = dbg!(s2n_get_openssl_version());
        println!("openssl version: {:x}", result);
        let result = dbg!(s2n_security_policies_init());
...
/*    
    ...
    */ /*
    unsafe {
        ...
        let result: c_int = dbg!(s2n_drbg_test(argc, argv));
