...
ret_t init_aes_ctr_prf_state(OUT aes_ctr_prf_state_t *s, IN uint32_t max_invokations, IN const seed_t *seed);
...
_INLINE_ void aes_ctr_prf_state_cleanup(IN OUT aes_ctr_prf_state_t *s) { finalize_aes_ctr_prf(s); }
