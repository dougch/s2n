...
void gf2x_mul_1x1( uint64_t *c, uint64_t a, uint64_t b )
{
...
void karatzuba_add1( OUT const uint64_t *res, IN const uint64_t *a, IN const uint64_t *b, IN const uint64_t n_half,
                     IN uint64_t *alah )
{
...
void karatzuba_add2( OUT uint64_t *res1, OUT uint64_t *res2, IN const uint64_t *res, IN const uint64_t *tmp,
