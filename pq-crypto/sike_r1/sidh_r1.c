...
{  // Alice's ephemeral public key generation
   ...
   // Output: the public key PublicKeyA consisting of 3 elements in GF(p^2) which are encoded by removing leading 0
   // bytes.
...
{  // Bob's ephemeral public key generation
   ...
   // Output: the public key PublicKeyB consisting of 3 elements in GF(p^2) which are encoded by removing leading 0
   // bytes.
