...
int BIKE1_L1_R2_crypto_kem_keypair( OUT unsigned char *pk, OUT unsigned char *sk )
{
    ...
    GUARD( generate_sparse_rep( ( uint64_t * )&p_sk[ 0 ], l_sk.wlist[ 0 ].val, DV, R_BITS, sizeof( p_sk[ 0 ] ),
                                &h_prf_state ) );
    ...
    GUARD( generate_sparse_rep( ( uint64_t * )&p_sk[ 1 ], l_sk.wlist[ 1 ].val, DV, R_BITS, sizeof( p_sk[ 1 ] ),
                                &h_prf_state ) );
