...
ret_t decode( OUT split_e_t *e, IN const syndrome_t *s, IN const ct_t *ct, IN const sk_t *sk );
...
void rotate_right( OUT syndrome_t *out, IN const syndrome_t *in, IN uint32_t bitscount );
