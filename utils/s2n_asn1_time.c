...
static parser_state process_state( parser_state state, char current_char, struct parser_args *args )
{
    switch ( state ) {
        ...
        case ON_YEAR_DIGIT_4:
            ...
            if ( args->time.tm_year < 0 ) { return PARSE_ERROR; }
        ...
        case ON_MONTH_DIGIT_2:
            ...
            if ( args->time.tm_mon < 0 || args->time.tm_mon > 11 ) { return PARSE_ERROR; }
        ...
        case ON_DAY_DIGIT_2:
            ...
            if ( args->time.tm_mday < 0 || args->time.tm_mday > 31 ) { return PARSE_ERROR; }
        ...
        case ON_HOUR_DIGIT_2:
            ...
            if ( args->time.tm_hour < 0 || args->time.tm_hour > 23 ) { return PARSE_ERROR; }
        ...
        case ON_MINUTE_DIGIT_2:
            ...
            if ( args->time.tm_min < 0 || args->time.tm_min > 59 ) { return PARSE_ERROR; }
        ...
        case ON_SECOND_DIGIT_2:
            ...
            if ( args->time.tm_sec < 0 || args->time.tm_sec > 59 ) { return PARSE_ERROR; }

            return ON_SUBSECOND;
        case ON_SUBSECOND:
            if ( current_char == '.' || isdigit( current_char ) ) { return ON_SUBSECOND; }
        /* fall through */
        case ON_TIMEZONE:
        ...
        case ON_OFFSET_HOURS_DIGIT_2:
            ...
            if ( args->offset_hours < 0 || args->offset_hours > 23 ) { return PARSE_ERROR; }
        ...
        case ON_OFFSET_MINUTES_DIGIT_2:
            ...
            if ( args->offset_minutes < 0 || args->offset_minutes > 23 ) { return PARSE_ERROR; }
...
int s2n_asn1_time_to_nano_since_epoch_ticks( const char *asn1_time, uint32_t len, uint64_t *ticks )
{
    ...
    if ( args.offset_negative ) { gmt_offset = 0 - gmt_offset; }
