...
/**
 * Given arrays "dest" and "src" of length "len", conditionally copy "src" to
 * "dest" The execution time of this function is independent of the values
 ...
 *
 */
int s2n_constant_time_copy_or_dont(uint8_t* dest, const uint8_t* src,
 ...
 */
int s2n_constant_time_pkcs1_unpad_or_dont(uint8_t* dst, const uint8_t* src,
                                          uint32_t srclen, uint32_t expectlen) {
