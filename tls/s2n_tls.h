...
#define s2n_server_can_send_ocsp(conn)                                                               \
    ((conn)->status_type == S2N_STATUS_REQUEST_OCSP && (conn)->handshake_params.our_chain_and_key && \
...
#define s2n_server_can_send_sct_list(conn)                                                                 \
    ((conn)->ct_level_requested == S2N_CT_SUPPORT_REQUEST && (conn)->handshake_params.our_chain_and_key && \
