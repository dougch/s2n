...
static int s2n_server_encrypted_extensions_parse(struct s2n_connection *conn,
 ...
 * This will be updated with the following issue to consolidate the functions
 * and remove duplication: https://github.com/awslabs/s2n/issues/1189
 */
int s2n_server_encrypted_extensions_parse(struct s2n_connection *conn,
                                          struct s2n_blob *extensions) {
