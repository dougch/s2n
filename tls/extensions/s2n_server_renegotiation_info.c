...
int s2n_recv_server_renegotiation_info_ext(struct s2n_connection *conn,
  ...
  S2N_ERROR_IF(s2n_stuffer_data_available(extension),
               S2N_ERR_NON_EMPTY_RENEGOTIATION_INFO);
  S2N_ERROR_IF(renegotiated_connection_len,
               S2N_ERR_NON_EMPTY_RENEGOTIATION_INFO);
