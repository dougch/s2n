...
int s2n_recv_client_renegotiation_info(struct s2n_connection *conn,
                                       struct s2n_stuffer *extension) {
  /* RFC5746 Section 3.2: The renegotiated_connection field is of zero length
  ...
  S2N_ERROR_IF(
      s2n_stuffer_data_available(extension) || renegotiated_connection_len,
