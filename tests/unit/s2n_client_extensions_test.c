...
int main(int argc, char **argv)
{
    ...
    /* Client sends multiple server names. */
    {
        ...
        EXPECT_EQUAL(write(io_pair.client, client_hello_message, sizeof(client_hello_message)),
    ...
    if (!s2n_is_in_fips_mode()) {
        ...
        /* All PQ KEM byte values are from https://tools.ietf.org/html/draft-campagna-tls-bike-sike-hybrid-02 */
        {
            ...
            EXPECT_SUCCESS(negotiate_kem(client_extensions, client_extensions_len, client_hello_message,
                                         ...
                                         TLS_PQ_KEM_EXTENSION_ID_SIKE_P434_R2, &io_pair));
        }
        {
            ...
            EXPECT_SUCCESS(negotiate_kem(client_extensions, client_extensions_len, client_hello_message,
                                         ...
                                         TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R1, &io_pair));
        }
        {
        ...
        }
        {
            ...
            EXPECT_SUCCESS(negotiate_kem(NULL, 0, client_hello_message, client_hello_len, "KMS-PQ-TLS-1-0-2020-02",
                                         TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R2, &io_pair));
        }
        {
