...
int main( int argc, char **argv )
{
    ...
    /* User tries adding a duplicate key to the server */
    {
        ...
        EXPECT_EQUAL(
            -1, s2n_config_add_ticket_crypto_key( server_config, ticket_key_name2, strlen( ( char * )ticket_key_name2 ),
        ...
        EXPECT_EQUAL(
            -1, s2n_config_add_ticket_crypto_key( server_config, ticket_key_name1, strlen( ( char * )ticket_key_name1 ),
