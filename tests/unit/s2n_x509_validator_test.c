...
int main( int argc, char **argv )
{
    ...
    /* test validator in unsafe mode */
    {
        ...
        EXPECT_SUCCESS(
            s2n_read_test_pem( S2N_DEFAULT_TEST_CERT_CHAIN, ( char * )cert_chain_pem, S2N_MAX_TEST_PEM_SIZE ) );
        ...
        EXPECT_EQUAL( S2N_CERT_OK, s2n_x509_validator_validate_cert_chain( &validator, connection, chain_data,
     ...
     * we are properly validating alternative names and common name.*/
    {
        ...
        uint8_t cert_chain_pem[ S2N_MAX_TEST_PEM_SIZE ];
        EXPECT_SUCCESS( s2n_read_test_pem( S2N_RSA_2048_SHA256_NO_DNS_SANS_CERT, ( char * )cert_chain_pem,
