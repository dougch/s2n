...
static int check_client_server_agreed_kem( const uint8_t iana_value[ S2N_TLS_CIPHER_SUITE_LEN ],
                                           uint8_t *client_kem_ids, const uint8_t num_client_kems,
                                           const struct s2n_kem *server_kem_pref_list[],
...
int main( int argc, char **argv )
{
    ...
    EXPECT_SUCCESS( check_client_server_agreed_kem( bike_iana, client_kems, 4, pq_kems_r1, 2,
    ...
    EXPECT_SUCCESS( check_client_server_agreed_kem( sike_iana, client_kems, 4, pq_kems_r1, 2,
...
}
{
    ...
    EXPECT_SUCCESS( check_client_server_agreed_kem( bike_iana, client_kems, 2, pq_kems_r1, 2,
                                                    TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R1 ) );
    EXPECT_SUCCESS( check_client_server_agreed_kem( bike_iana, client_kems, 2, pq_kems_r2r1, 4,
                                                    TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R1 ) );
    EXPECT_SUCCESS( check_client_server_agreed_kem( sike_iana, client_kems, 2, pq_kems_r1, 2,
                                                    TLS_PQ_KEM_EXTENSION_ID_SIKE_P503_R1 ) );
...
}
{
    ...
    EXPECT_SUCCESS( check_client_server_agreed_kem( bike_iana, client_kems, 2, pq_kems_r2r1, 4,
                                                    TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R2 ) );
    EXPECT_FAILURE_WITH_ERRNO( check_client_server_agreed_kem( sike_iana, client_kems, 2, pq_kems_r1, 2,
                                                               TLS_PQ_KEM_EXTENSION_ID_SIKE_P434_R2 ),
                               S2N_ERR_KEM_UNSUPPORTED_PARAMS );
    EXPECT_SUCCESS( check_client_server_agreed_kem( sike_iana, client_kems, 2, pq_kems_r2r1, 4,
                                                    TLS_PQ_KEM_EXTENSION_ID_SIKE_P434_R2 ) );
...
}
{
    ...
    EXPECT_FAILURE_WITH_ERRNO(
        ...
        S2N_ERR_KEM_UNSUPPORTED_PARAMS );
    EXPECT_FAILURE_WITH_ERRNO( check_client_server_agreed_kem( bike_iana, client_kems, 2, pq_kems_r2r1, 4,
                                                               TLS_PQ_KEM_EXTENSION_ID_BIKE1_L1_R2 ),
                               S2N_ERR_KEM_UNSUPPORTED_PARAMS );
    EXPECT_SUCCESS( check_client_server_agreed_kem( sike_iana, client_kems, 2, pq_kems_r1, 2,
                                                    TLS_PQ_KEM_EXTENSION_ID_SIKE_P503_R1 ) );
