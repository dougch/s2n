                                        ...
                                        uint32_t server_key_message_length, uint32_t client_key_message_length )
{
    ...
    GUARD( ReadHex( kat_file, expected_server_key_message, server_key_message_length,
                    "expected_server_key_exchange = " ) );
    ...
    eq_check( client_conn->handshake.io.write_cursor - client_conn->handshake.io.read_cursor,
    ...
    GUARD( ReadHex( kat_file, expected_client_key_message, client_key_message_length,
                    "expected_client_key_exchange = " ) );
