...
int s2n_record_parse_cbc( const struct s2n_cipher_suite *cipher_suite, struct s2n_connection *conn,
...
int s2n_record_parse_wrapper( int *xor_pad, int *digest_pad, int padding_length, int encrypted_length,
                              uint8_t content_type )
{
    ...
    return s2n_record_parse_cbc( &cipher_suite, &conn, content_type, encrypted_length, implicit_iv, &hmac,
